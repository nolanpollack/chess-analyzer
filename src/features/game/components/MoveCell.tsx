...
export function MoveCell({ move, active, onClick }: MoveCellProps) {
	...
	return (
		<button
			type="button"
			onClick={onClick}
			className={`inline-flex items-center gap-1 rounded-xs border px-1.5 py-0.5 mono-nums font-mono text-sm transition-colors duration-100 ${
				active
